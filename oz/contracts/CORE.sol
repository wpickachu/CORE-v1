...
contract CORE is NBUNIERC20 {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "CORE::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "CORE::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "CORE::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "CORE::_writeCheckpoint: block number exceeds 32 bits"
        );
